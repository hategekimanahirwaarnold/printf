# _printf
```_printf``` is a custom implementation of the C programming function ```printf```. This project is an application of the C programming knowledge that [main School](https://www.mainschool.com/) cohort 14 students have learned.
...
## Authors
[Renato Leon](https://github.com/renatoleonmain) | [Joshua Enrico](https://github.com/yoyogold-a11)
